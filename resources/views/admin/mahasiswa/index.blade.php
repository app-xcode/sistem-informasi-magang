...
<div class="space-y-6">
    ...
    <div class="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
        <form method="GET" action="{{ route('admin.mahasiswa.index') }}" class="flex flex-col gap-3 lg:flex-row">
            ...
            <button type="submit" name="export" value="excel" class="rounded-lg border border-slate-300 px-4 py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-50">
    ...
    <div class="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-slate-200 text-sm">
                <thead>
                    <tr>
                        <th class="px-5 py-3 text-left"><x-table-sort column="nama" label="Mahasiswa" /></th>
                        <th class="px-5 py-3 text-left"><x-table-sort column="nim" label="NIM" /></th>
                        <th class="px-5 py-3 text-left"><x-table-sort column="program_studi" label="Program Studi" /></th>
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    @empty
                        <tr><td colspan="5" class="px-5 py-12 text-center text-sm text-slate-500">Belum ada data mahasiswa.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
