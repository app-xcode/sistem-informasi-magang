...
<div class="grid gap-5 md:grid-cols-2">
    <div class="md:col-span-2">
        <label for="nama_instansi" class="mb-1.5 block text-sm font-semibold text-slate-700">Nama Instansi <span class="text-rose-500">*</span></label>
        <input id="nama_instansi" name="nama_instansi" value="{{ old('nama_instansi', $instansi->nama_instansi ?? '') }}" required maxlength="150"
    ...
    <div class="md:col-span-2">
        ...
        <textarea id="alamat" name="alamat" rows="4" required
            class="w-full rounded-lg border border-slate-300 px-3.5 py-2.5 text-sm outline-none focus:border-slate-500 focus:ring-2 focus:ring-slate-200">{{ old('alamat', $instansi->alamat ?? '') }}</textarea>
    ...
    <div>
        ...
        <input id="no_telp" name="no_telp" value="{{ old('no_telp', $instansi->no_telp ?? '') }}" maxlength="20"
            class="w-full rounded-lg border border-slate-300 px-3.5 py-2.5 text-sm outline-none focus:border-slate-500 focus:ring-2 focus:ring-slate-200">
    ...
    <div>
        ...
        <input id="email" name="email" type="email" value="{{ old('email', $instansi->email ?? '') }}" maxlength="150"
            class="w-full rounded-lg border border-slate-300 px-3.5 py-2.5 text-sm outline-none focus:border-slate-500 focus:ring-2 focus:ring-slate-200">
    ...
    <div class="md:col-span-2">
        ...
        <input id="penanggung_jawab" name="penanggung_jawab" value="{{ old('penanggung_jawab', $instansi->penanggung_jawab ?? '') }}" maxlength="100"
            class="w-full rounded-lg border border-slate-300 px-3.5 py-2.5 text-sm outline-none focus:border-slate-500 focus:ring-2 focus:ring-slate-200">
...
<div class="mt-6 flex flex-col-reverse gap-3 border-t border-slate-200 pt-5 sm:flex-row sm:justify-end">
    <a href="{{ route('admin.instansi.index') }}" class="rounded-lg border border-slate-300 px-4 py-2.5 text-center text-sm font-semibold text-slate-700 hover:bg-slate-50">Batal</a>
