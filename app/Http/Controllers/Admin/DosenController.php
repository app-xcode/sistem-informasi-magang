...
class DosenController extends Controller
{
    ...
    {
        if ($dosen->magang()->exists()) {
            return back()->with('error', 'Dosen tidak dapat dihapus karena sudah memiliki data magang.');
        }

        if ($dosen->penilaian()->exists()) {
            return back()->with('error', 'Dosen tidak dapat dihapus karena sudah memiliki data penilaian.');
        }
